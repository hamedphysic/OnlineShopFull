...
{
    public class OrderServiceBackOffice : IOrderServiceBackOffice
    {
        private readonly IOrderRepository _orderRepository;
        private readonly IProductRepository _productRepository;
        private readonly UserManager<OnlineShopUser> _userManager;

        public OrderServiceBackOffice(IOrderRepository orderRepository, IProductRepository productRepository, UserManager<OnlineShopUser> userManager)
        {
